...
pub mod display {
    ...
    pub const LVCONF_PATH: &str = "480x320"; // Used by the Makefile
    // Normally 1/10th of the display size
    pub const LVGL_BUFFER_LEN: usize = 7680;
    pub mod pins {
        use super::super::p;
        pub const SUB_BANK: usize = 4;
        pub const DATAREG_ADDR_BIT: usize = 12;
        pub const AF: u8 = 12;
        pub type BACKLIGHT = p::PG8;
        pub type CS = p::PG12;
        pub type RESET = p::PB12;
        pub type DATAREG = p::PG2;
    }
}
